...
public class Control extends AppCompatActivity {
    ...
    private SwitchCompat swden1;
    private SwitchCompat swden2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDHT=findViewById(R.id.btnDHT);
        ...
        imageView1 = findViewById(R.id.offLed);
        imageView2 = findViewById(R.id.lightOff);



        /////////////////////////////////////////////////////////////ÂM THANH
        final MediaPlayer click = MediaPlayer.create(this, R.raw.click_button);

        /////////////////////////////////////////////////////////////////////

        //xử lý nút switch
        //Kiểm tra xem trang thái switch có thay đổi hay không
        ...
        den1_data = FirebaseDatabase.getInstance().getReference();//Nhận dữ liệu từ firebase
        thanhden1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                if(i<10)//neu i<10
                {
                    ...
                    den1_data.child("MUCSANGDEN1").setValue(0);
                    dosang=0;//mức sáng = 0
                    phantramden1.setText(dosang+"%");
                } else if (i>=10 && i<20) {
                    den1_data.child("MUCSANGDEN1").setValue(10);
                    dosang=10;
                    phantramden1.setText(dosang+"%");
                }
                else if (i>=20 && i<30) {
                    den1_data.child("MUCSANGDEN1").setValue(20);
                    dosang=20;
                    phantramden1.setText(dosang+"%");
                }
                else if (i>=30 && i<40) {
                    den1_data.child("MUCSANGDEN1").setValue(30);
                    dosang=30;
                    phantramden1.setText(dosang+"%");
                }
                else if (i>=40 && i<50) {
                    den1_data.child("MUCSANGDEN1").setValue(40);
                    dosang=40;
                    phantramden1.setText(dosang+"%");
                }
                else if (i>=50 && i<60) {
                    den1_data.child("MUCSANGDEN1").setValue(50);
                    dosang=50;
                    phantramden1.setText(dosang+"%");
                }
                else if (i>=60 && i<70) {
                    den1_data.child("MUCSANGDEN1").setValue(60);
                    dosang=60;
                    phantramden1.setText(dosang+"%");
                }
                else if (i>=70 && i<80) {
                    ...
                    den1_data.child("MUCSANGDEN1").setValue(70);
                    dosang=80;
                    phantramden1.setText(dosang+"%");
                }

                else if (i>=90 && i<100) {
                    den1_data.child("MUCSANGDEN1").setValue(90);
                    dosang=90;
                    phantramden1.setText(dosang+"%");
                }
                else {
                    den1_data.child("MUCSANGDEN1").setValue(100);
                    dosang=100;
                    phantramden1.setText(dosang+"%");
                }
        ...
        thanhden2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                {
                    //biến den1_data sẽ truy tới mức giá trị của đèn 1 trên firebase và set giá trị thành 0
                    den2_data.child("MUCSANGDEN2").setValue(0);
                    dosang=0;//mức sáng = 0
                    phantramden2.setText(dosang+"%");
                } else if (i>=10 && i<20) {
                    den2_data.child("MUCSANGDEN2").setValue(10);
                    dosang=10;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=20 && i<30) {
                    den2_data.child("MUCSANGDEN2").setValue(20);
                    dosang=20;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=30 && i<40) {
                    den2_data.child("MUCSANGDEN2").setValue(30);
                    dosang=30;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=40 && i<50) {
                    den2_data.child("MUCSANGDEN2").setValue(40);
                    dosang=40;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=50 && i<60) {
                    den2_data.child("MUCSANGDEN2").setValue(50);
                    dosang=50;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=60 && i<70) {
                    den2_data.child("MUCSANGDEN2").setValue(60);
                    dosang=60;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=70 && i<80) {
                    ...
                    den2_data.child("MUCSANGDEN2").setValue(70);
                    dosang=80;
                    phantramden2.setText(dosang+"%");
                }
                else if (i>=90 && i<100) {
                    den2_data.child("MUCSANGDEN2").setValue(90);
                    dosang=90;
                    phantramden2.setText(dosang+"%");
                }
                else {
                    den2_data.child("MUCSANGDEN2").setValue(100);
                    dosang=100;
                    phantramden2.setText(dosang+"%");
                }
        ...
        nhietdodata.child("cambiendht/nhietdo").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                nhietdo.setText("Nhiệt độ: "+ Nhietdo + " \u2103");
            }
...
//                finish();
        ...
        ////////////////////////////////////////////////////////////////////DHT
        //Xử lý button logout đăng xuất
        btnDHT.setOnClickListener(new View.OnClickListener() {
            @Override
            //Khi nhấn nút sẽ chuyển về trang
            public void onClick(View v) {

                startActivity(new Intent(Control.this, DHT11.class));
//                finish();
            }
        });
    ...
    private void sw2_onoff(){
        ...
        {
            sw2data.child("SWT2").setValue(1);//set giá trị thành 1

            ///////////////////////////////////////////đổi ảnh
            imageView2.setImageResource(R.drawable.light_bulb_off);
            swden2.setText("OFF");
            swith = true;
            ////////////////////////////////////////////
        }else {
            sw2data.child("SWT2").setValue(0);//ngược lại là 0

            /////////////////////////////////////////đổi ảnh
            imageView2.setImageResource(R.drawable.light_bulb_on);
            swden2.setText("ON");
            swith = false;
            ////////////////////////////////////////////
        }
    ...
    private void sw1_onoff(){
        ...
        if(!sw1data_status){
            sw1data.child("SWT1").setValue(1);

            ///////////////////////////////////////////đổi ảnh
            imageView1.setImageResource(R.drawable.light_bulb_off);
            swden1.setText("OFF");
            swith = true;
        }else {
            sw1data.child("SWT1").setValue(0);

            ///////////////////////////////////////////đổi ảnh
            imageView1.setImageResource(R.drawable.light_bulb_on);
            swden1.setText("ON");
            swith = false;
            ////////////////////////////////////////////
        }
